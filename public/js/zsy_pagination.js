      ...
      function ($) {
          $.extend({
              "easypage": function (options) {
                  ...
                  //拼接导航按钮
                  var navigatehtml =
                      "<div id='pagefirst' class='pagefirst'><a href='javascript:void(0)'>首页</a></div><div id='pagepre' class='pagepre'><a href='javascript:void(0)'>上一页</a></div>";
                  for (var i = 1; i <= pagecount; i++) {
                      navigatehtml += '<div class="pagenavigate"><a href="javascript:void(0)">' + i +
                          '</a></div>';
                  }
                  navigatehtml +=
                      "<div id='pagenext' class='pagenext'><a href='javascript:void(0)'>下一页</a></div><div id='pagelast' class='pagelast'><a href='javascript:void(0)'>尾页</a></div>";
                  ...
                  $.extend({
                      "shownavigate": function (currentnavigate) {
                          $.hidenavigates();
                          var begin = currentnavigate >= options.navigatecount ?
                              currentnavigate - parseInt(options.navigatecount) : 0;
                          if (begin > navigates.length - 2 * options.navigatecount) {
                              begin = navigates.length - 2 * options.navigatecount;
                          }
                          for (var i = begin; i < currentnavigate + parseInt(options
                                  .navigatecount); i++) {
                              $(navigates[i]).show();
                          }
                      }
                      ...
                      "showPage": function (page) {
                          contents.each(
                              function (contentindex) {
                                  if (contentindex >= page * options.everycount &&
                                      contentindex < (page + 1) * options.everycount
                                      ) {
                                      $(this).show();
                                  } else {
                                      $(this).hide();
                      ...
                      function (myindex) {
                          $(this).click(
                              function () {
                                  ...
                                  var na = Math.floor((currentpage + 1) / options
                                      .navigatecount) * options.navigatecount;
                                  $.shownavigate(na);
                              }
                          );
                      }
                  ...
                  $("#pagepre").click(
                      function () {
                          ...
                          $.hidePreNext(currentpage);
                          var na = Math.floor(currentpage / options.navigatecount) * options
                              .navigatecount;
                          $.shownavigate(na);
                      }
                  );
                  ...
                  $("#pagenext").click(
                      function () {
                          ...
                          var na = Math.floor((currentpage + 1) / options.navigatecount) * options
                              .navigatecount;
                          $.shownavigate(na);
                      }
                  );
